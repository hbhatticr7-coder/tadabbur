    ...
    <div className="lg:col-span-5 lg:pt-4">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-baseline flex-wrap gap-x-4 gap-y-1">
          ...
          <span className="font-body text-base" style={{ color: "#4a4239" }}>— {rootMeaningText}</span>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        {hasOccurrences ? (
          ...
          <p className="font-body text-sm italic" style={{ color: "#7a6e5e" }}>
            Cross-verse links for this root have not yet been gathered.
          </p>
        )}
      </div>
